...
Select your Pump browser session or add a Solana wallet on the extension's Wallets page. Imported wallets sign the Pump login message locally and are encrypted in browser profile storage. Anyone with access to your unlocked browser profile may still be able to use them.
